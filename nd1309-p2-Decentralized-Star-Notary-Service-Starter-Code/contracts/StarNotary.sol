...
contract StarNotary is ERC721Full {
    ...
    constructor() public ERC721Full('Maha Token','MTKN'){}
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(ownerOf(_tokenId1) == msg.sender || ownerOf(_tokenId2) == msg.sender, 'Unable to exchange stars that are not owned by sender.');
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerOf(_tokenId), 'You cannot transfer tokens that you do not own.');
